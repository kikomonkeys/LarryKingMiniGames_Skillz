...
public class ControlAvatars : MonoBehaviour {
    ...
    void Start() {
        PoolGame_GameManager.Instance.controlAvatars = this;
        speed1 = speed;
    ...
    public void reset() {
        ...
        PoolGame_GameManager.Instance.readyToAnimateCoins = false;
            ...
            if (foundPlayer) {
                ...
                if (speed1 < speed * (2.8f / 4.0f) && !changedAvatar) {
                    ...
                    if (PoolGame_GameManager.Instance.avatarOpponent != null)
                        lastAvatar.GetComponent<Image>().sprite = PoolGame_GameManager.Instance.avatarOpponent;
                    else
                ...
                if (OpponentAvatar != null && OpponentAvatar.GetComponent<RectTransform>().anchoredPosition.y <= 0) {
                    ...
                    opponentNameText.text = PoolGame_GameManager.Instance.nameOpponent;
                    ...
                    if (/*PhotonNetwork.playerList.Length < 2 || */playerRejected)
                    {
                        ...
                        StartCoroutine(countDownCoins(PoolGame_GameManager.Instance.payoutCoins));
                    }
                    PoolGame_GameManager.Instance.readyToAnimateCoins = true;
    ...
    private void coinsAnimate() {
        ...
        if (PoolGame_GameManager.Instance.payoutCoins >= 1000) {
            if (PoolGame_GameManager.Instance.payoutCoins >= 1000000) {
                if (PoolGame_GameManager.Instance.payoutCoins % 1000000.0f == 0) {
                    my.text = (PoolGame_GameManager.Instance.payoutCoins / 1000000.0f).ToString("0") + "M";
                    oppontent.text = (PoolGame_GameManager.Instance.payoutCoins / 1000000.0f).ToString("0") + "M";
                } else {
                    my.text = (PoolGame_GameManager.Instance.payoutCoins / 1000000.0f).ToString("0.0") + "M";
                    oppontent.text = (PoolGame_GameManager.Instance.payoutCoins / 1000000.0f).ToString("0.0") + "M";
                }

            } else {
                if (PoolGame_GameManager.Instance.payoutCoins % 1000.0f == 0) {
                    my.text = (PoolGame_GameManager.Instance.payoutCoins / 1000.0f).ToString("0") + "k";
                    oppontent.text = (PoolGame_GameManager.Instance.payoutCoins / 1000.0f).ToString("0") + "k";
                } else {
                    my.text = (PoolGame_GameManager.Instance.payoutCoins / 1000.0f).ToString("0.0") + "k";
                    oppontent.text = (PoolGame_GameManager.Instance.payoutCoins / 1000.0f).ToString("0.0") + "k";
                }

            }
        } else {
            oppontent.text = PoolGame_GameManager.Instance.payoutCoins + "";
            my.text = PoolGame_GameManager.Instance.payoutCoins + "";
        }
    ...
    public IEnumerator updateMessageBubbleText() {
        ...
        if (waitingOpponentTime > 0 && !opponentActive && !PoolGame_GameManager.Instance.opponentDisconnected) {
