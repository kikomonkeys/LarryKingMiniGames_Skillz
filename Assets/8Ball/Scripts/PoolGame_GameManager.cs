...
public class PoolGame_GameManager {
    private static PoolGame_GameManager instance;
   ...
   // public IAPController IAPControl;
    ...
    private PoolGame_GameManager() { }

    public static PoolGame_GameManager Instance {
        get {
            if (instance == null) {
                instance = new PoolGame_GameManager();
            }
            return instance;
        }
    }
